...
// import { useGetAllWalletsQuery } from "../services/walletApi";
...
export function Wallet() {
  ...
  const { data, isLoading, isError, refetch } = useGetAllWalletsQuery({
    limit: 40,
    page: 1,
  });
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={handleRefresh}
            disabled={isLoading}
            className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 bg-white border rounded-lg hover:bg-gray-50 disabled:opacity-60 transition-colors"
          >
            {isLoading ? (
      ...
      {/* Search */}
      <div className="bg-gray-50 p-4 rounded-xl border border-gray-300 shadow-sm">
      ...
      <div className="bg-white rounded-xl border border-gray-300 shadow-sm overflow-hidden">
        {isLoading ? (
          ...
          <div className="p-12 text-center text-gray-500">
            No customers with wallet data found
          </div>
        ) : (
          <table className="w-full text-sm text-left">
            <thead className="bg-gray-50 text-gray-600 text-xs uppercase">
              <tr>
                ...
                <th className="px-6 py-3">Has Wallet</th>
              </tr>
            </thead>
              ...
              {filteredCustomers.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-2 text-gray-600">{c.phone || "—"}</td>
                    <td className="px-6 py-2 text-gray-600">{c.email || "N/A"}</td>
                    <td className="px-6 py-2 font-semibold text-green-700">
                      ₹{(item.walletBalance || 0).toFixed(2)}
                    </td>
                    <td className="px-6 py-2">
                      <span
